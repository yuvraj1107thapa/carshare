          ...
          db.collection("posts")
            ...
            .onSnapshot((snapshot2) => {
              snapshot2.docs.map((doc2) => {
                ...
                if (doc2.data().username !== user.displayName) {
                  dispatch({
  ...
  return (
    <div className="homeHeader">
      <div className="homeHeaderLogoAndSearch">
        ...
        {/* <Avatar className="searchAvatar" src="" /> */}
          ...
          {notifications.length == 0 ? (
            <div className="noNotifDiv">
              ...
              <h1 className="NoNotif">
                It seems that there are no active notifications
              </h1>
            </div>
          ) : (
            console.log()
            ...
            <a href="#" className="announcement">
              <div className="optionDrop">
                ...
                <div className="announcementInfo">
                  <h1>
                    {notification.username} <span>commented to your post.</span>
                  </h1>
                </div>
              </div>
            </a>
            ...
            <a href="#">
              <div className="optionDrop">
                ...
                <div className="sideinfoDrop">
                  <h1>Give Feedback</h1>
                  <p>Help us improve the new CarShare</p>
                </div>
              </div>
            </a>
            <div className="hr" />
